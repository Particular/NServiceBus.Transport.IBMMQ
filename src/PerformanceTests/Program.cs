...
using NServiceBus.PerformanceTests.Infrastructure;
using NServiceBus.PerformanceTests.Reporting;
using NServiceBus.PerformanceTests.Scenarios;
...
var rootCommand = new RootCommand(TestInfrastructure.GetTestSuiteName())
{
    scenariosOption,
...
rootCommand.SetAction(async (parseResult, cancellationToken) =>
{
    ...
    ConsoleLog.WriteLine(ConsoleLog.Bold(TestInfrastructure.GetTestSuiteName()));
